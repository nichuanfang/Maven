		...
		<div id="page-wrapper">
			...
			<div class="panel panel-default">
				<div class="panel-body">
					<form class="form-inline" action="${pageContext.request.contextPath }/customerlist.action" method="get">
						...
						<div class="form-group">
							...
							<select	class="form-control" id="customerFrom" placeholder="客户来源" name="custsource">
								...
								<c:forEach items="${custSourcelist}" var="item">
                                <option value="${item.dictId}" <c:if test="${vo.custsource==item.dictId}">selected</c:if>>${item.dictItemName}</option>
								</c:forEach>
							</select>
						</div>
						<div class="form-group">
							...
							<select	class="form-control" id="custIndustry"  name="custindustry">
								<option value="">--请选择--</option>
								<c:forEach items="${custIndustrylist}" var="item">
									<option value="${item.dictId}" <c:if test="${vo.custindustry==item.dictId}">selected</c:if>>${item.dictItemName}</option>
								</c:forEach>
							</select>
						</div>
						<div class="form-group">
							...
							<select	class="form-control" id="custLevel" name="custlevel">
								<option value="">--请选择--</option>
								<c:forEach items="${custLevellist}" var="item">
									<option value="${item.dictId}" <c:if test="${vo.custlevel==item.dictId}">selected</c:if>>${item.dictItemName}</option>
								</c:forEach>
							</select>
						</div>
