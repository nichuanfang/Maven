...
public class NavigationTag extends TagSupport {
    ...
    public int doStartTag() throws JspException {
        ...
        PageBean page = (PageBean)request.getAttribute(bean);
        if (page == null) {
            return SKIP_BODY;
        }
        ...
        try {
        	//计算总页数
        	int pageCount = page.getTotalCount() / page.getPageSize();
            ...
            int indexPage = (page.getCurrentPage() - 2 > 0)? page.getCurrentPage() - 2 : 1;  
